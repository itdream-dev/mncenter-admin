							...
							<div class="subscribe-header">
								<div class="row">
									...
									<div class="col-xs-9 col-sm-8">
										<div class="title-text">Subscribe to our newsletter!</div>
										<p>Join 20,000 subscribers and receive monthly freebies and special offers and access to exclusive members-only content</p>
									</div>
								</div>
							</div>
							<div class="subscribe-footer">
								<div class="row" id="subscribe-step1">
									...
									<div class="col-xs-6 col-sm-5" style="padding-right:0">
										<button class="btn btn-block btn-subscribe" onclick="subscribe()"><span class="glyphicon glyphicon-refresh spinning"></span>&nbsp;SUBSCRIBE</button>
									</div>
								</div>
