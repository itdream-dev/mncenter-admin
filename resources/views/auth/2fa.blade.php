@extends('layouts.app')
@section('content')
<div class="container" style="padding: 100px 0px; min-height:725px">
  <div class="row">
    <div class="col-md-8 col-md-offset-2">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <br/><br/>
          <strong>3.Your second-factor backup code is <strong style="font-size:17px">{{$data['user']->passwordSecurity->backup_code}}</strong></strong><br/><br/>
          <p>This can be used for reset 2fa setting of your account in case your mobile phone is lost or stolen. </p>
          @elseif($data['user']->passwordSecurity->google2fa_enable)
          <div class="alert alert-success">
